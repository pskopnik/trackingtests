#ifndef GOMORYHU_AGGREGATION_H_
#define GOMORYHU_AGGREGATION_H_

/**
 * Applies the Gomory Hu Aggregator to partitions generated by a DCG.
 *
 * Output:
